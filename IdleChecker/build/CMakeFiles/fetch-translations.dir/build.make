...
CMakeFiles/fetch-translations: releaseme
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/build/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Downloading translations for KIdleTest branch trunk..."
	git -C /build/build/releaseme pull
	cmake -E remove_directory /build/build/po
	cmake -E remove_directory /build/build/poqm
	ruby /build/build/releaseme/fetchpo.rb --origin trunk --project KIdleTest --output-dir /build/build/po --output-poqm-dir /build/build/poqm /build

releaseme:
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/build/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Fetching releaseme scripts to download translations..."
...
CMakeFiles/fetch-translations.dir/depend:
	cd /build/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /build /build /build/build /build/build /build/build/CMakeFiles/fetch-translations.dir/DependInfo.cmake "--color=$(COLOR)"
